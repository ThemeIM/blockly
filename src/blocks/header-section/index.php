    ...
    function blockly_render_header_section( $attributes ) {
        $banner_items_one = [
            [
                ...
                'image_src' => '/images/element/element-6.png'
            ],
            [
                'class' => 'banner-group-element-two',
                'image_src' => '/images/element/REPLACE-THIS-SCREEN1111211171111.png'
            ],
            [
                'class' => 'banner-group-element-three',
                'image_src' => '/images/element/project/project-1.png'
            ],
            [
                'class' => 'banner-group-element-four',
                'image_src' => '/images/element/project/project-2.png'
            ],
            [
                'class' => 'banner-group-element-five',
                'image_src' => '/images/element/project/project-3.png'
            ],
            [
                'class' => 'banner-group-element-six',
                'image_src' => '/images/element/project/project-4.png'
            ],
            [
                'class' => 'banner-group-element-seven',
                'image_src' => '/images/element/project/project-5.png'
            ],
            [
                'class' => 'banner-group-element-eight',
                'image_src' => '/images/element/project/project-6.png'
            ],
            [
                'class' => 'banner-group-element-nine',
                'image_src' => '/images/element/project/project-7.png'
            ],
            [
                'class' => 'banner-group-element-ten',
                'image_src' => '/images/element/project/project-8.png'
            ],
        ];
        ...
        $banner_items_two = [
            [
                ...
                'image_src' => '/images/element/element-9.png'
            ],
            [
                'class' => 'banner-group-element-thirteen',
                'image_src' => '/images/element/element-10.png'
            ],
            [
                'class' => 'banner-group-element-fourteen',
                'image_src' => '/images/element/element-12.png'
            ],
            [
                'class' => 'banner-group-element-fifteen',
                'image_src' => '/images/element/element-11.png'
            ],
            [
...
<div class="banner-section blockly-full">
    <div class="banner-element">
        <img src="<?php echo BLY_ASSETS_URL.'/images/element/element-5.png'; ?>" alt="element">
    </div>
    <div class="banner-group-shape">
        <?php foreach ($banner_items_one as $element) { ?>
            <div class="<?php echo $element['class']; ?>">
                <img src="<?php echo BLY_ASSETS_URL . '/' . $element['image_src']; ?>" alt="element">
            </div>
        <?php } ?>
            ...
            <div class="col-xl-7 col-lg-8 mb-30">
                <div class="banner-content" data-aos="fade-right" data-aos-duration="1800">
                    <div class="banner-content-element">
                        <img src="<?php echo BLY_ASSETS_URL; ?>/images/element/element-4.png" alt="element">
                    </div>
                    <h3 class="sub-title"><?php echo $attributes['subtitle']; ?></h3>
                    <h1 class="title"><?php echo esc_html($attributes['title']); ?></h1>
                    ...
                    <div class="banner-arrow">
                        <img src="<?php echo BLY_ASSETS_URL.'/images/element/element-1.png'; ?>" alt="element">
                    </div>
                    <div class="banner-widget">
                        <div class="banner-widget-wrapper">
                            <div class="banner-widget-left">
                                <div class="banner-widget-thumb">
                                    <img src="<?php echo BLY_ASSETS_URL; ?>/images/element/element-2.png" alt="element">
                                </div>
                            </div>
                            ...
                            <div class="banner-widget-right">
                                <div class="banner-widget-thumb">
                                    <img src="<?php echo BLY_ASSETS_URL; ?>/images/element/element-3.png" alt="element">
                                </div>
                            </div>
                        </div>
                    </div>
